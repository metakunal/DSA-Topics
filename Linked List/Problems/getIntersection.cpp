...
int getIntersectionHashing(Node *head1, Node *head2)
{
...
//-------------METHOD-1 In O(1) Extra Space-----------
//Helper Functon to find the count of the Linekd List
...
int main()
{
	...
	*/
    ...
    cout << getIntersectionHashing(head1, head2) << endl;
